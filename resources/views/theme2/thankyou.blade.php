...
<div class="container" style="max-width: 800px; margin: 50px auto; padding: 20px;">
    <!-- Thank You Message -->
    <div style="border: 2px dashed #0073aa; padding: 30px; text-align: center; margin-bottom: 30px; background-color: #f8f9fa;">
        <h2 style="color: #0073aa; font-weight: bold; margin: 0;">Thank you. Your order has been received.</h2>
    </div>
        ...
        <div style="background-color: #fff; padding: 20px; margin-bottom: 30px; border: 1px solid #ddd;">
            <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 20px; margin-bottom: 20px;">
                <div>
                    ...
                    <span style="color: #0073aa;">{{ $orderData->order_no }}</span>
                </div>
                <div>
                ...
                <div>
                    ...
                    <span style="color: #0073aa; font-weight: bold;">Rs: {{ number_format($orderData->amount, 2) }}</span>
                </div>
                <div>
        ...
        <div style="background-color: #fff; padding: 20px; border: 1px solid #ddd;">
            ...
            <table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
                ...
                <tfoot>
                    ...
                    <tr style="border-top: 2px solid #0073aa;">
                        <td style="padding: 12px; font-weight: bold; font-size: 18px;">TOTAL:</td>
                        <td style="text-align: right; padding: 12px; font-weight: bold; font-size: 18px; color: #0073aa;">
                            Rs: {{ number_format($orderData->amount, 2) }}
                        </td>
                    </tr>
                </tfoot>
            </table>
    ...
    @else
        <div style="text-align: center; padding: 40px;">
            ...
            <a href="{{ url('/') }}" style="display: inline-block; margin-top: 20px; padding: 12px 30px; background-color: #0073aa; color: #fff; text-decoration: none; border-radius: 4px;">
                Go to Homepage
            </a>
        </div>
    @endif
