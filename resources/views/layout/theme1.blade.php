...
<link rel="apple-touch-icon-precomposed" href="{{ $assets_url }}images/logo/favicon.png">
    ...
    @include('them1.header')
                                    ...
                                    <div class="swiper-wrapper">
                                            ...
                                            <div class="card-product style-skincare">
                                                <div class="card-product-wrapper">
                                                    <a href="product-detail.html" class="product-img">
                                                        <img class="lazyload img-product" data-src="{{ $assets_url }}images//products/skincare-1.jpg" src="{{ $assets_url }}images//products/skincare-1.jpg" alt="image-product">
                                                        <img class="lazyload img-hover" data-src="{{ $assets_url }}images//products/skincare-2.jpg" src="{{ $assets_url }}images//products/skincare-2.jpg" alt="image-product">
                                                    </a>
                                        ...
                                        <div class="swiper-slide" lazy="true">
                                            <div class="card-product style-skincare">
                                                <div class="card-product-wrapper">
                                                    <a href="product-detail.html" class="product-img">
                                                        <img class="lazyload img-product" data-src="{{ $assets_url }}images//products/skincare-3.jpg" src="{{ $assets_url }}images//products/skincare-3.jpg" alt="image-product">
                                                        <img class="lazyload img-hover" data-src="{{ $assets_url }}images//products/skincare-4.jpg" src="{{ $assets_url }}images//products/skincare-4.jpg" alt="image-product">
                                                    </a>
                                                    <div class="list-product-btn">
                                                        <a href="javascript:void(0);" class="box-icon bg_white wishlist btn-icon-action">
                                                            <span class="icon icon-heart"></span>
                                        ...
                                        <div class="swiper-slide" lazy="true">
                                            <div class="card-product style-skincare">
                                                <div class="card-product-wrapper">
                                                    <a href="product-detail.html" class="product-img">
                                                        <img class="lazyload img-product" data-src="{{ $assets_url }}images//products/skincare-5.jpg" src="{{ $assets_url }}images//products/skincare-5.jpg" alt="image-product">
                                                        <img class="lazyload img-hover" data-src="{{ $assets_url }}images//products/skincare-6.jpg" src="{{ $assets_url }}images//products/skincare-6.jpg" alt="image-product">
                                                    </a>
                                                    <div class="list-product-btn">
                                                        <a href="javascript:void(0);" class="box-icon bg_white wishlist btn-icon-action">
                                                            <span class="icon icon-heart"></span>
                                        ...
                                        <div class="swiper-slide" lazy="true">
                                            <div class="card-product style-skincare">
                                                <div class="card-product-wrapper">
                                                    <a href="product-detail.html" class="product-img">
                                                        <img class="lazyload img-product" data-src="{{ $assets_url }}images//products/skincare-7.jpg" src="{{ $assets_url }}images//products/skincare-7.jpg" alt="image-product">
                                                        <img class="lazyload img-hover" data-src="{{ $assets_url }}images//products/skincare-8.jpg" src="{{ $assets_url }}images//products/skincare-8.jpg" alt="image-product">
                                                    </a>
                                                    <div class="list-product-btn">
                                                        <a href="javascript:void(0);" class="box-icon bg_white wishlist btn-icon-action">
                                                            <span class="icon icon-heart"></span>
                                        ...
                                        <div class="swiper-slide" lazy="true">
                                            <div class="card-product style-skincare">
                                                <div class="card-product-wrapper">
                                                    <a href="product-detail.html" class="product-img">
                                                        <img class="lazyload img-product" data-src="{{ $assets_url }}images//products/skincare-9.jpg" src="{{ $assets_url }}images//products/skincare-9.jpg" alt="image-product">
                                                        <img class="lazyload img-hover" data-src="{{ $assets_url }}images//products/skincare-10.jpg" src="{{ $assets_url }}images//products/skincare-10.jpg" alt="image-product">
                                                    </a>
                                                    <div class="list-product-btn">
                                                        <a href="javascript:void(0);" class="box-icon bg_white wishlist btn-icon-action">
                                                            <span class="icon icon-heart"></span>
                                        ...
                                        <div class="swiper-slide" lazy="true">
                                            <div class="card-product style-skincare">
                                                <div class="card-product-wrapper">
                                                    <a href="product-detail.html" class="product-img">
                                                        <img class="lazyload img-product" data-src="{{ $assets_url }}images//products/skincare-11.jpg" src="{{ $assets_url }}images//products/skincare-11.jpg" alt="image-product">
                                                        <img class="lazyload img-hover" data-src="{{ $assets_url }}images//products/skincare-12.jpg" src="{{ $assets_url }}images//products/skincare-12.jpg" alt="image-product">
                                                    </a>
                                                    <div class="list-product-btn">
                                                        <a href="javascript:void(0);" class="box-icon bg_white wishlist btn-icon-action">
                                                            <span class="icon icon-heart"></span>
                                        ...
                                        <div class="swiper-slide" lazy="true">
                                            <div class="card-product style-skincare">
                                                <div class="card-product-wrapper">
                                                    <a href="product-detail.html" class="product-img">
                                                        <img class="lazyload img-product" data-src="{{ $assets_url }}images//products/skincare-13.jpg" src="{{ $assets_url }}images//products/skincare-13.jpg" alt="image-product">
                                                        <img class="lazyload img-hover" data-src="{{ $assets_url }}images//products/skincare-14.jpg" src="{{ $assets_url }}images//products/skincare-14.jpg" alt="image-product">
                                                    </a>
                                                    <div class="list-product-btn">
                                                        <a href="javascript:void(0);" class="box-icon bg_white wishlist btn-icon-action">
                                                            <span class="icon icon-heart"></span>
                                        ...
                                        <div class="swiper-slide" lazy="true">
                                            <div class="card-product style-skincare">
                                                <div class="card-product-wrapper">
                                                    <a href="product-detail.html" class="product-img">
                                                        <img class="lazyload img-product" data-src="{{ $assets_url }}images//products/skincare-15.jpg" src="{{ $assets_url }}images//products/skincare-15.jpg" alt="image-product">
                                                        <img class="lazyload img-hover" data-src="{{ $assets_url }}images//products/skincare-16.jpg" src="{{ $assets_url }}images//products/skincare-16.jpg" alt="image-product">
                                                    </a>
                                                    <div class="list-product-btn">
                                                        <a href="javascript:void(0);" class="box-icon bg_white wishlist btn-icon-action">
                                                            <span class="icon icon-heart"></span>
        ...
        <section class="tf-slideshow slider-video position-relative">
            <div class="banner-wrapper">
                <img class="lazyload" src="{{ $assets_url }}images//collections/banner-collection-1.jpg" data-src="{{ $assets_url }}images//collections/banner-collection-1.jpg" src="{{ $assets_url }}images//collections/banner-collection-1.jpg" alt="image-collection">
            ...
            <div class="container">
                <div class="tf-grid-layout md-col-2 tf-img-video-text">
                    ...
                    <div class="video-wrap">
                        <video class="radius-20" src="{{ $assets_url }}images//slider/video-1.mp4" playsinline metadata controls></video>
                    </div>
                </div>
            </div>
        </section>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active show" id="organic" role="tabpanel">
                            <div class="widget-card-store radius-20 overflow-hidden type-1 align-items-center tf-grid-layout md-col-2">
                                <div class="store-img">
                                    <img class="lazyload" data-src="{{ $assets_url }}images//shop/store/ourstore4.jpg" src="{{ $assets_url }}images//shop/store/ourstore4.jpg" alt="store-img">
                                </div>
                        ...
                        <div class="tab-pane" id="cruelty" role="tabpanel">
                            <div class="widget-card-store radius-20 overflow-hidden type-1 align-items-center tf-grid-layout md-col-2">
                                <div class="store-img">
                                    <img class="lazyload" data-src="{{ $assets_url }}images//shop/store/ourstore5.jpg" src="{{ $assets_url }}images//shop/store/ourstore5.jpg" alt="store-img">
                                </div>
                                <div class="store-item-info text-center">
                        ...
                        <div class="tab-pane" id="sustainable" role="tabpanel">
                            <div class="widget-card-store radius-20 overflow-hidden type-1 align-items-center tf-grid-layout md-col-2">
                                <div class="store-img">
                                    <img class="lazyload" data-src="{{ $assets_url }}images//shop/store/ourstore6.jpg" src="{{ $assets_url }}images//shop/store/ourstore6.jpg" alt="store-img">
                                </div>
                                <div class="store-item-info text-center">
        ...
        <section class="flat-spacing-9 bg_grey-6">
            <div class="container">
                ...
                <div class="wrap-carousel">
                    <div class="swiper tf-sw-recent" data-preview="4" data-tablet="3" data-mobile="2" data-space-lg="30" data-space-md="15" data-space="15" data-pagination="2" data-pagination-md="3" data-pagination-lg="3">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide" lazy="true">
                                <div class="card-product style-skincare">
                                    <div class="card-product-wrapper">
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="testimonial-item lg lg-2">
                                        <div class="icon">
                                            <img class="lazyload" data-src="{{ $assets_url }}images//item/quote.svg" alt="img" src="{{ $assets_url }}images//item/quote.svg">
                                        </div>
                                        ...
                                        <div class="author box-author">
                                            <div class="box-img d-md-none rounded-0">
                                                <img class="lazyload img-product" data-src="{{ $assets_url }}images//slider/te4.jpg" src="{{ $assets_url }}images//slider/te4.jpg" alt="image-product">
                                            </div>
                                            <div class="content">
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-item lg lg-2">
                                        <div class="icon">
                                            <img class="lazyload" data-src="{{ $assets_url }}images//item/quote.svg" alt="" src="{{ $assets_url }}images//item/quote.svg">
                                        </div>
                                        ...
                                        <div class="author box-author">
                                            <div class="box-img d-md-none rounded-0">
                                                <img class="lazyload img-product" data-src="{{ $assets_url }}images//slider/te6.jpg" src="{{ $assets_url }}images//slider/te6.jpg" alt="image-product">
                                            </div>
                                            <div class="content">
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="grid-img-group style-ter-1">
                                        <div class="box-img item-1 hover-img">
                                            <div class="img-style">
                                                <img class="lazyload" data-src="{{ $assets_url }}images//slider/te8.jpg" src="{{ $assets_url }}images//slider/te8.jpg" alt="img-slider">
                                            </div>
                                        </div>
                                        <div class="box-img item-2 hover-img">
                                            <div class="img-style">
                                                <img class="lazyload" data-src="{{ $assets_url }}images//slider/te7.jpg" src="{{ $assets_url }}images//slider/te7.jpg" alt="img-slider">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="grid-img-group style-ter-1">
                                        <div class="box-img item-1 hover-img">
                                            <div class="img-style">
                                                <img class="lazyload" data-src="{{ $assets_url }}images//slider/te10.jpg" src="{{ $assets_url }}images//slider/te10.jpg" alt="img-slider">
                                            </div>
                                        </div>
                                        <div class="box-img item-2 hover-img">
                                            <div class="img-style">
                                                <img class="lazyload" data-src="{{ $assets_url }}images//slider/te9.jpg" src="{{ $assets_url }}images//slider/te9.jpg" alt="img-slider">
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <section class="flat-spacing-3 pb_0">
            <div class="container">
                ...
                <div id="image-compare" class="wow fadeInUp" data-wow-delay="0s">
                    <img class="lazyload" data-src="{{ $assets_url }}images//shop/file/skincare_before.jpg" src="{{ $assets_url }}images//shop/file/skincare_before.jpg" alt="" />
                    <img class="lazyload" data-src="{{ $assets_url }}images//shop/file/skincare_after.jpg" src="{{ $assets_url }}images//shop/file/skincare_after.jpg" alt="" />
                </div>
            </div>
        </section>
        <!-- /testimonials-before-after -->
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="gallery-item hover-img wow fadeInUp" data-wow-delay="0s">
                                <div class="img-style">
                                    <img class="lazyload img-hover" data-src="{{ $assets_url }}images//shop/gallery/gallery-9.jpg" src="{{ $assets_url }}images//shop/gallery/gallery-9.jpg" alt="image-gallery">
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="gallery-item hover-img wow fadeInUp" data-wow-delay=".1s">
                                <div class="img-style">
                                    <img class="lazyload img-hover" data-src="{{ $assets_url }}images//shop/gallery/gallery-10.jpg" src="{{ $assets_url }}images//shop/gallery/gallery-10.jpg" alt="image-gallery">
                                </div>
                                <a href="#quick_add" data-bs-toggle="modal" class="box-icon"><span class="icon icon-bag"></span> <span class="tooltip">Quick Add</span></a>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="gallery-item hover-img wow fadeInUp" data-wow-delay=".2s">
                                <div class="img-style">
                                    <img class="lazyload img-hover" data-src="{{ $assets_url }}images//shop/gallery/gallery-11.jpg" src="{{ $assets_url }}images//shop/gallery/gallery-11.jpg" alt="image-gallery">
                                </div>
                                <a href="#quick_add" data-bs-toggle="modal" class="box-icon"><span class="icon icon-bag"></span> <span class="tooltip">Quick Add</span></a>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="gallery-item hover-img wow fadeInUp" data-wow-delay=".3s">
                                <div class="img-style">
                                    <img class="lazyload img-hover" data-src="{{ $assets_url }}images//shop/gallery/gallery-12.jpg" src="{{ $assets_url }}images//shop/gallery/gallery-12.jpg" alt="image-gallery">
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="gallery-item hover-img wow fadeInUp" data-wow-delay=".4s">
                                <div class="img-style">
                                    <img class="lazyload img-hover" data-src="{{ $assets_url }}images//shop/gallery/gallery-13.jpg" src="{{ $assets_url }}images//shop/gallery/gallery-13.jpg" alt="image-gallery">
                                </div>
                                <a href="product-detail.html" class="box-icon"><span class="icon icon-bag"></span> <span class="tooltip">View product</span></a>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="gallery-item hover-img wow fadeInUp" data-wow-delay=".4s">
                                <div class="img-style">
                                    <img class="lazyload img-hover" data-src="{{ $assets_url }}images//shop/gallery/gallery-14.jpg" src="{{ $assets_url }}images//shop/gallery/gallery-14.jpg" alt="image-gallery">
                                </div>
                                <a href="product-detail.html" class="box-icon"><span class="icon icon-bag"></span> <span class="tooltip">View product</span></a>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="gallery-item hover-img wow fadeInUp" data-wow-delay=".4s">
                                <div class="img-style">
                                    <img class="lazyload img-hover" data-src="{{ $assets_url }}images//shop/gallery/gallery-15.jpg" src="{{ $assets_url }}images//shop/gallery/gallery-15.jpg" alt="image-gallery">
                                </div>
                                <a href="product-detail.html" class="box-icon"><span class="icon icon-bag"></span> <span class="tooltip">View product</span></a>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="gallery-item hover-img wow fadeInUp" data-wow-delay=".4s">
                                <div class="img-style">
                                    <img class="lazyload img-hover" data-src="{{ $assets_url }}images//shop/gallery/gallery-16.jpg" src="{{ $assets_url }}images//shop/gallery/gallery-16.jpg" alt="image-gallery">
                                </div>
                                <a href="product-detail.html" class="box-icon"><span class="icon icon-bag"></span> <span class="tooltip">View product</span></a>
                            </div>
                        </div>
                            ...
                            <div class="col-xl-3 col-md-6 col-12">
                                <div class="footer-infor">
                                    <div class="footer-logo">
                                        <a href="index.html">
                                            <img src="{{ $assets_url }}images//logo/logo.svg" alt="">
                                        </a>
                                    </div>
                                    <ul>
                                        <li>
                    ...
                    <div class="row-demo">
                        <div class="demo-item">
                            <a href="index.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload" data-src="{{ $assets_url }}images//demo/home-01.jpg" src="{{ $assets_url }}images//demo/home-01.jpg" alt="home-01">
                        ...
                        <div class="demo-item">
                            <a href="home-multi-brand.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload" data-src="{{ $assets_url }}images//demo/home-multi-brand.jpg" src="{{ $assets_url }}images//demo/home-multi-brand.jpg" alt="home-multi-brand">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                        ...
                        <div class="demo-item">
                            <a href="home-02.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload" data-src="{{ $assets_url }}images//demo/home-02.jpg" src="{{ $assets_url }}images//demo/home-02.jpg" alt="home-02">
                                    <div class="demo-label">
                                        <span class="demo-hot">Hot</span>
                                    </div>
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-03.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ $assets_url }}images//demo/home-03.jpg" src="{{ $assets_url }}images//demo/home-03.jpg" alt="home-03">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-04.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ $assets_url }}images//demo/home-04.jpg" src="{{ $assets_url }}images//demo/home-04.jpg" alt="home-04">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-05.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ $assets_url }}images//demo/home-05.jpg" src="{{ $assets_url }}images//demo/home-05.jpg" alt="home-05">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-06.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload" data-src="{{ $assets_url }}images//demo/home-06.jpg" src="{{ $assets_url }}images//demo/home-06.jpg" alt="home-06">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                                    </div>
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-07.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ $assets_url }}images//demo/home-07.jpg" src="{{ $assets_url }}images//demo/home-07.jpg" alt="home-07">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-08.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ $assets_url }}images//demo/home-08.jpg" src="{{ $assets_url }}images//demo/home-08.jpg" alt="home-08">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-skincare.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ $assets_url }}images//demo/home-skincare.jpg" src="{{ $assets_url }}images//demo/home-skincare.jpg" alt="home-skincare">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-headphone.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ $assets_url }}images//demo/home-headphone.jpg" src="{{ $assets_url }}images//demo/home-headphone.jpg" alt="home-headphone">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-giftcard.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ $assets_url }}images//demo/home-giftcard.jpg" src="{{ $assets_url }}images//demo/home-giftcard.jpg" alt="home-gift-card">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-furniture.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ $assets_url }}images//demo/home-furniture.jpg" src="{{ $assets_url }}images//demo/home-furniture.jpg" alt="home-furniture">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-furniture-02.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ $assets_url }}images//demo/home-furniture2.jpg" src="{{ $assets_url }}images//demo/home-furniture2.jpg" alt="home-furniture-2">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-skateboard.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ $assets_url }}images//demo/home-skateboard.jpg" src="{{ $assets_url }}images//demo/home-skateboard.jpg" alt="home-skateboard">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-stroller.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ $assets_url }}images//demo/home-stroller.jpg" src="{{ $assets_url }}images//demo/home-stroller.jpg" alt="home-stroller">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-decor.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ $assets_url }}images//demo/home-decor.jpg" src="{{ $assets_url }}images//demo/home-decor.jpg" alt="home-decor">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-electronic.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ $assets_url }}images//demo/home-electronic.jpg" src="{{ $assets_url }}images//demo/home-electronic.jpg" alt="home-electronic">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-setup-gear.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ $assets_url }}images//demo/home-setup-gear.jpg" src="{{ $assets_url }}images//demo/home-setup-gear.jpg" alt="home-setup-gear">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-dog-accessories.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ $assets_url }}images//demo/home-dog-accessories.jpg" src="{{ $assets_url }}images//demo/home-dog-accessories.jpg" alt="home-dog-accessories">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-kitchen-wear.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ $assets_url }}images//demo/home-kitchen.jpg" src="{{ $assets_url }}images//demo/home-kitchen.jpg" alt="home-kitchen-wear">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-phonecase.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ $assets_url }}images//demo/home-phonecase.jpg" src="{{ $assets_url }}images//demo/home-phonecase.jpg" alt="home-phonecase">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-paddle-boards.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ $assets_url }}images//demo/home_paddle_board.jpg" src="{{ $assets_url }}images//demo/home_paddle_board.jpg" alt="home-paddle_board">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-glasses.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ $assets_url }}images//demo/home-glasses.jpg" src="{{ $assets_url }}images//demo/home-glasses.jpg" alt="home-glasses">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-pod-store.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ $assets_url }}images//demo/home-pod-store.jpg" src="{{ $assets_url }}images//demo/home-pod-store.jpg" alt="home-pod-store">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-activewear.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ $assets_url }}images//demo/home-activewear.jpg" src="{{ $assets_url }}images//demo/home-activewear.jpg" alt="home-activewear">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-handbag.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ $assets_url }}images//demo/home-handbag.jpg" src="{{ $assets_url }}images//demo/home-handbag.jpg" alt="home-handbag">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-tee.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ $assets_url }}images//demo/home-tee.jpg" src="{{ $assets_url }}images//demo/home-tee.jpg" alt="home-tee">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-sock.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ $assets_url }}images//demo/home-socks.jpg" src="{{ $assets_url }}images//demo/home-socks.jpg" alt="home-sock">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-jewerly.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ $assets_url }}images//demo/home-jewelry.jpg" src="{{ $assets_url }}images//demo/home-jewelry.jpg" alt="home-jewelry">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-sneaker.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ $assets_url }}images//demo/home-sneaker.jpg" src="{{ $assets_url }}images//demo/home-sneaker.jpg" alt="home-sneaker">
                                </div>
                        ...
                        <div class="tf-col-content">
                            ...
                            <div class="tf-search-hidden-inner">
                                <div class="tf-loop-item">
                                    <div class="image">
                                        <a href="product-detail.html">
                                            <img src="{{ $assets_url }}images//products/white-3.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="content">
                                ...
                                <div class="tf-loop-item">
                                    <div class="image">
                                        <a href="product-detail.html">
                                            <img src="{{ $assets_url }}images//products/white-2.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="content">
                                ...
                                <div class="tf-loop-item">
                                    <div class="image">
                                        <a href="product-detail.html">
                                            <img src="{{ $assets_url }}images//products/white-1.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="content">
                ...
                <ul class="nav-ul-mb" id="wrapper-menu-navigation">
                    <li class="nav-mb-item">
                        <a href="shop-default.html" class="tf-category-link mb-menu-link">
                            <div class="image">
                                <img src="{{ $assets_url }}images//shop/cate/cate1.jpg" alt="">
                            </div>
                    ...
                    <li class="nav-mb-item">
                        <a href="shop-default.html" class="tf-category-link mb-menu-link">
                            <div class="image">
                                <img src="{{ $assets_url }}images//shop/cate/cate2.jpg" alt="">
                            </div>
                            <span>Dog</span>
                        </a>
                    </li>
                    <li class="nav-mb-item">
                        <a href="shop-default.html" class="tf-category-link mb-menu-link">
                            <div class="image">
                                <img src="{{ $assets_url }}images//shop/cate/cate3.jpg" alt="">
                            </div>
                            <span>Grocery</span>
                        </a>
                    </li>
                    <li class="nav-mb-item">
                        <a href="shop-default.html" class="tf-category-link mb-menu-link">
                            <div class="image">
                                <img src="{{ $assets_url }}images//shop/cate/cate4.png" alt="">
                            </div>
                            <span>Handbag</span>
                        </a>
                    </li>
                    <li class="nav-mb-item">
                        <a href="#cate-menu-one" class="tf-category-link has-children collapsed mb-menu-link" data-bs-toggle="collapse" aria-expanded="true" aria-controls="cate-menu-one">
                            <div class="image">
                                <img src="{{ $assets_url }}images//shop/cate/cate5.jpg" alt="">
                            </div>
                            <span>Fashion</span>
                            <span class="btn-open-sub"></span>
                        </a>
                            ...
                            <ul class="sub-nav-menu" id="cate-menu-navigation">
                                <li>
                                    <a href="#cate-shop-one" class="tf-category-link has-children sub-nav-link collapsed"  data-bs-toggle="collapse" aria-expanded="true" aria-controls="cate-shop-one">
                                        <div class="image">
                                            <img src="{{ $assets_url }}images//shop/cate/cate6.jpg" alt="">
                                        </div>
                                        <span>Mens</span>
                                        <span class="btn-open-sub"></span>
                                    </a>
                                    <div id="cate-shop-one" class="collapse">
                                        <ul class="sub-nav-menu sub-menu-level-2">
                                            ...
                                            <li>
                                                <a href="shop-default.html" class="tf-category-link sub-nav-link">
                                                    <div class="image">
                                                        <img src="{{ $assets_url }}images//shop/cate/cate8.jpg" alt="">
                                                    </div>
                                                    <span>Shoes</span>
                                                </a>
                                            </li>
                                ...
                                <li>
                                    <a href="#cate-shop-two" class="tf-category-link has-children sub-nav-link collapsed"  data-bs-toggle="collapse" aria-expanded="true" aria-controls="cate-shop-two">
                                        <div class="image">
                                            <img src="{{ $assets_url }}images//shop/cate/cate9.jpg" alt="">
                                        </div>
                                        <span>Womens</span>
                                        <span class="btn-open-sub"></span>
                                    </a>
                                    <div id="cate-shop-two" class="collapse">
                                        <ul class="sub-nav-menu sub-menu-level-2">
                                            ...
                                            <li>
                                                <a href="shop-default.html" class="tf-category-link sub-nav-link">
                                                    <div class="image">
                                                        <img src="{{ $assets_url }}images//shop/cate/cate7.jpg" alt="">
                                                    </div>
                                                    <span>Tee</span>
                                                </a>
                                            </li>
                                ...
                                <div class="tf-compare-offcanvas">
                                    <div class="tf-compare-item">
                                        <div class="position-relative">
                                            ...
                                            <a href="product-detail.html">
                                                <img class="radius-3" src="{{ $assets_url }}images//products/orange-1.jpg" alt="">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="tf-compare-item">
                                        <div class="position-relative">
                                            ...
                                            <a href="product-detail.html">
                                                <img class="radius-3" src="{{ $assets_url }}images//products/pink-1.jpg" alt="">
                                            </a>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="modal-content">
                ...
                <div class="wrap">
                    <div class="tf-product-info-item">
                        <div class="image">
                            <img src="{{ $assets_url }}images//products/orange-1.jpg" alt="">
                        </div>
                        <div class="content">
                    ...
                    <div class="tf-product-info-buy-button">
                        <form class="">
                            ...
                            <div class="w-100">
                                <a href="#" class="btns-full">Buy with <img src="{{ $assets_url }}images//payments/paypal.png" alt=""></a>
                    ...
                    <div class="tf-product-media-wrap">
                        <div class="swiper tf-single-slide">
                            <div class="swiper-wrapper" >
                                ...
                                <div class="swiper-slide">
                                    <div class="item">
                                        <img src="{{ $assets_url }}images//products/pink-1.jpg" alt="">
                                    </div>
                                </div>
                            </div>
            ...
            <div class="modal-content">
                ...
                <div class="tf-rte">
                    ...
                    <div class="tf-page-size-chart-content">
                        ...
                        <div>
                            <img class="sizechart lazyload" data-src="{{ $assets_url }}images//shop/products/size_chart2.jpg" src="{{ $assets_url }}images//shop/products/size_chart2.jpg" alt="">
                        </div>
                    </div>
                </div>
            </div>
