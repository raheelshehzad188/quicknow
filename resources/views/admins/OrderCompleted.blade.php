            ...
            <div class="ibox-content">
                ...
                <div class="table-responsive">
                  <div style="display: flex; justify-content: end;">
                        <a style="width: auto;" id="perform-action-btn" class="btn btn-danger btn-block">Delete Selected Records </a>
                  </div>
   ...
   $(document).ready(function(){
            $('#fetch-api').DataTable({
                ...
                dom: '<"html5buttons"B>lTfgitp',
                 ajax: '{{ url("admin/custom_api"); }}?status=3',
              processing: true,
              serverSide: true,
              "bDestroy": true,
                buttons: [
    ...
    $('#perform-action-btn').click(function() {
        // Send selected rows to server
        $.ajax({
            url: '{{ url("admin/del_all_com")}}',
            method: 'POST',
            data: {
