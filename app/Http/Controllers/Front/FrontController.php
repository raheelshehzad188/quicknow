    ...
    private function send_grid($to, $subj, $html)
{
    ...
    ->first();
            ...
            Session::forget('cart');
            return redirect('/thank-you/' . $lastid)->with([
    ...
    public function thankyou($id)
    {
        ...
        if($order->count() > 0) {
            ...
            $assets_url = env('APP_URL') . 'public/theme2/';
            return view('theme2.thankyou', compact('order', 'layout', 'assets_url'));
        } else {
    ...
    {
        $search_query = $request->get('q', $request->get('text', ''));
