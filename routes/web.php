...
Route::get('/search-autocomplete',[Front\FrontController::class,'search_autocomplete'])->name('search.autocomplete');
...
Route::get('/thank-you/{id}',[Front\FrontController::class,'thankyou'])->name('thankyou');
